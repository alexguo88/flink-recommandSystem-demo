package com.demo.flink.process;
...
public class TopNHotItems extends KeyedProcessFunction<Tuple, TopProductEntity, List<String>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        // 状态的注册
        ListStateDescriptor<TopProductEntity> itemsStateDesc = new ListStateDescriptor<>("itemState-state", TopProductEntity.class);
